export type PendingRecord = { id: string; module: string; payload: Record<string, unknown>; status: "pendiente" | "conflicto" | "error"; error?: string; route?: string; method?: "POST" | "PATCH" };
